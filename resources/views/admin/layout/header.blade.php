        ...
        <div class="main-bar clearfix ">
            <div class="container-fluid clearfix">
                ...
                <div class="logo-header mostion logo-dark">
                    <a href="front-dashboard.html"><img src="{{ asset('back/assets/images/logo-text.png') }}"
                            alt=""></a>
                </div>
                <!-- Nav Toggle Button -->
...
<div class="menu-sidebar">
    <div class="contact-box">
        <ul>
            ...
            <li class="nav-item">
                <a class="nav-link" href="front-support.html">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item">
                <a class="nav-link" href="javascript:void();" onclick="$('#logout_form').submit();">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
